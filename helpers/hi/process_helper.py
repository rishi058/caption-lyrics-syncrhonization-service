...
def process_devanagari_script(lines: list[str]) -> list[dict]:
    """
    ...
    refined_words = LLMService().refine_lat(formatted_words)
...
def process_latin_script(lines: list[str]) -> list[dict]:
    """
    ...
    refined_words = LLMService().refine_dev(formatted_words)
